...
const PROJECT_DATA: ProjectProps[] = [
  {
    ...
    description: '<strong>SpeedThru Potzol’s Puzzle</strong> ist eines dieser Spiele die man früher auf der Konsole einfach hatte. ' +
      'Die Steuerung hat mir schon immer gefallen und die Mischung aus Fast-Paced und 3D-Puzzle fand ich genial und erinnert mich an den <strong>Rubik’s Cube</strong>. ' +
  ...
  },
  {
    ...
    description: 'Nach der Vorlesung für verteilte Systeme war dieses Projekt eine sehr coole Anwendung, um sich mal ein bisschen mit TCP, UDP, Clients und Sockets die Hände schmutzig zu machen. ' +
      'Die Idee von meinem Pong Klon war es sich nebenbei noch mit Items zu bekämpfen während man natürlich noch den Ball jonglieren muss.',
  ...
  },
  {
    ...
    description: 'Im Master Projekt im Rahmen des M-Lab der UHH haben wir für die Abteilung der Erziehungswissenschaften eine Software entwickelt um einen Test für eine Studie durchzuführen. ' +
      ...
      'Es kann direkt in der Software ein Teilnehmer ausgewertet werden, sodass am Ende ein kompakter Excel export entsteht, mit dem die Wissenschaftler ihre weiteren Auswertungen anwenden können. ' +
