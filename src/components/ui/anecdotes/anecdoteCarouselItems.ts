...
export const CAROUSEL_DATA_TOP: TechAnecdoteData[] = [
  ...
  },
  {
    ...
    title: 'React',
    anecdote: 'Gerade für Sideprojects nutze ich immer gerne React für die UI, schnell installiert und einfach drauf los.',
  },
  {
    iconName: IconName.SPRING_BOOT,
    color: getIconColor(IconName.SPRING_BOOT),
    title: 'SpringBoot',
    anecdote: 'Nach einer der nervenaufreibensten Migrationen von Spring nach SpringBoot habe ich so einiges gelernt. SpringBoot ist für mich dabei immer noch einer der besten Backend Frameworks.',
  },
  {
...
export const CAROUSEL_DATA_MIDDLE: TechAnecdoteData[] = [
  {
    ...
    title: 'TypeScript',
    anecdote: 'Als daily driver in verschiedenen Frameworks komme ich sehr gut mit TypeScript zu recht. Auch wenn es manchmal seine JavaScript tücken hat, mag ich den mix aus Objekt-Orientierten und Funktionalen Elementen.'
  },
  {
